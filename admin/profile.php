						...
						<div class="row"> 
							<div class="col-md-6"> 
								...
								<?php 
									if (isset($_POST['update'])){
										...
										if (empty($profile)){
											...
											if ($result) {
												move_uploaded_file($_FILES['profile']['tmp_name'], "upload-image/$profiles");
											}
										}
									}
								 ?>
								...
								<form method="post" enctype="multipart/form-data"> 
									<?php 
										echo "<img src='upload-image/$profiles' class='col-md-12' style='height: 250px;'>";
									 ?>
							...
							<div class="col-md-6"> 
								...
								<form method="post"> 
									...
									<input type="submit" name="update_pass" class="btn btn-info" value="Update_Password">
								</form>
							</div>
						</div>
					</div>
