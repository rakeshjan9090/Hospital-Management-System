						...
						<div class="col-md-3 bg-success mx-2" style="height: 130px;">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-4">
										<a href="admin.php"><i class="fa-solid fa-users fa-3x my-4" style="color: white;"></i></a>
						...
						<div class="col-md-3 bg-danger mx-2 my-2" style="height: 130px;">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-4">
										<a href="report.php"><i class="fa-sharp fa-solid fa-flag fa-3x my-4" style="color: white;"></i></a>
										<i class=""></i>
										<!-- <i class="fa-solid fa-users.cog fa-3x"></i> -->
									</div>
								</div>
						...
						<div class="col-md-3 bg-warning mx-2 my-2" style="height: 130px;">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-4">
										<a href="job_request.php"><i class="fa-sharp fa-solid fa-file-pen fa-3x my-4" style="color: white;"></i></a>
										<!-- <i class="fa-solid fa-users.cog fa-3x"></i> -->
									</div>
								</div>
							</div>
