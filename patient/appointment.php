	 				...
	 				<?php 
	 					...
	 					if (isset($_POST['book'])) {
	 						...
	 						if (empty($sym)) {
	 							...
	 							$query = "INSERT INTO appointment(firstname, surname, gender, phone, appointment_date, symtoms, status, date_booking) VALUES('$firstname', '$surname', '$gender', '$phone', '$date', '$sym', 'pendding', NOW())";
